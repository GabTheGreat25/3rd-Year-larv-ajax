  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (key, value) {
        ...
        var accessories =
          "<form class='bg-white shadow-md rounded px-8 pt-6 pb-8 mx-2'><div class='item'><div class='itemDetails'><div class='itemImage'><img src=" +
          '/storage/' +
          value.image_path +
          ...
          "</p>      </div><button type='button' class='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 add'>Add to cart</button></div></form>"
  ...
  $('#checkout').click(function () {
    ...
    $('#cartItems')
      ...
      .each(function (i, element) {
        ...
        accessoriesid = parseInt($(element).find($('.accessoriesid')).html())
