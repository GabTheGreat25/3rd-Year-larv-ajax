...
<head>
    ...
    <title>Register As Operator</title>
    ...
    <header class="static m-7">
      <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div class="p-4 flex flex-row items-center justify-between">
          <a href="login" class="text-lg font-semibold tracking-widest text-gray-50 uppercase rounded-lg dark-mode:text-white">RedFrame CAM RENT</a>
        ...
        <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
          <form class="order-first mb-10 md:mb-0 md:order-last md:pr-8" action="{{ route('user.login') }}" id="loginform" method="POST">
            {{ csrf_field() }}
            <input class="mr-2 h-full w-50 py-1 pl-3 pr-10 rounded-full focus:outline-0" type="email" placeholder="E-mail"
                name="email"  id="email">
                <input class="mr-3 h-full w-50 py-2 pl-3 pr-10 rounded-full focus:outline-0" type="password" placeholder="Password"
                name="password" id="password">
                <button class="px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-gray-200 rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" id="loginbtn"  type="submit">Log In</button>
        </form>
        </nav>
      </div>
    </header>
...
<body class="w-full h-auto bg-no-repeat bg-cover" style="background-image: url('https://wallpapers.com/images/file/fujifilm-x-pro2-camera-e3j9dwe6sxs64c7o.jpg');">
        ...
        <div class="flex justify-center px-10 my-12">
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div class="w-full lg:w-1/2 bg-white p-1 rounded-lg">
                    <h3 class="pt-4 text-2xl text-center">Register As Operator</h3>
                    <form class="px-8 pt-6 bg-white rounded" id="oform" action="#" method="#"
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                id="address" name="address" type="text" placeholder="Enter Your Address" />
                        </div>
                        <div class="mb-4">
