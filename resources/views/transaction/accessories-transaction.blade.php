...
<div id="shoppingCart">
    <div id="cartItemsContainer">
        ...
        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" id="checkout">Checkout</button>
        <span id="cartTotal"></span>
    </div>
</div>
<hr class="my-8 h-px bg-gray-50 border-2 mx-28">
<div class="container px-29 grid grid-cols-2" id="accessories">
</div>
@endsection