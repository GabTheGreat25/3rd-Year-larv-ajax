...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js"
    integrity="sha512-8NOmlkzoskIBni4iy5onHC57Mndt17mZgWkYJvxe5jwBJu3spYIRSjTkYJ9OLNS9Min+bsSqbDfGaoejWxyFiw=="
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.21/js/jquery.dataTables.min.js"
    ...
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-buttons/2.0.1/js/dataTables.buttons.min.js"
    integrity="sha512-QZc1PH3GIO39Sd0/aCa+z7oytor2FmU8n/mjOheSAAZen9KBInfBcl1DLoNpFFZu9DbToWq+OBaVOpOBYkoX+w=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-select/1.3.3/dataTables.select.min.js"
    integrity="sha512-uMQIzRTYB4sDMMdkz8SocjrrNFpJvQjmAfrDrAHZe348+5451qsU8HAWxeB5stYB3XdiPGYupJfV2vgVw5oRGQ=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
{{-- <script src="https://unpkg.com/infinite-scroll@4/dist/infinite-scroll.pkgd.js"></script> --}}
{{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jscroll/#.#.#/jquery.jscroll.min.js"></script> --}}

<script src="{{ asset('js/acc-transaction.js') }}"></script>